...
// Mobile number (comes from Customers.ContactNo via backend)
const mobile =
  invoice.Mobile ||
  invoice.mobile ||
  invoice.ContactNo ||
...
// Installment number (from receipt line)
const installmentNo =
  invoice.InstallmentNo ||
  invoice.installmentNo ||
  (invoice.lines?.length ? invoice.lines[0].installmentCode : null) ||
  "-";
...
const status =
  invoice.PPU ||
  invoice.ppu ||
  (invoice.lines?.length ? invoice.lines[0].ppu : null) ||
  "-";
